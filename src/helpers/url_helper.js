...
//LOGIN
export const POST_FAKE_LOGIN = "/user/login";
...
export const GET_PROFILE = "/user/get";
export const CREATE_EMPLOYEE = "/user";
export const PROCESS = "/processflow";
export const PROCESSADD = "/process";
export const PROJECTION = "/payment-projection";
export const GET_EMPLOYEE = "/user";
export const CREATE_CARD_REQUEST = "/card-request";
export const GET_CARD_REQUEST = "/card-request";
export const CREATE_CARD = "/card";
export const CREATE_CASH = "/cash";
export const DEPARTMENT = "/department";
export const DEVISION = "/devision";
export const POSITION = "/position";
export const ROLE = "/role";
export const SUPPLIERPO = "/suppliers-po";
export const SUPPLIERPAYMENTREQUEST = "/suppliers-payment-request";
export const SUPPLIERPAYMENT = "/suppliers-payment";
export const SUPPLIERPAYMENTLINEITEM = "/suppliers-payment-line-item";
