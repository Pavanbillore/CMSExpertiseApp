...
// Login Method
export const updatepermissionApi = data => api.create(url.ROLE+'/updatepermission', data);
export const updateEmployeeApi = (data) => api.update(url.CREATE_EMPLOYEE + '/' + data.id, data);
export const createEmployeeApi = data => api.create(url.CREATE_EMPLOYEE, data);
export const getEmployess = (data) => api.get(url.GET_EMPLOYEE);
export const createprocessApi = data => api.create(url.PROCESS, data);
export const updateprocessApi = (data, id) => api.update(url.PROCESS+'/'+id, data);
export const getprocess = (data) => api.get(url.PROCESS+'/'+data);
export const getdatafunctionApi = (data) => api.get(data);
export const createprocessaddApi = data => api.create(url.PROCESSADD, data);
export const createprocessreplyApi = data => api.create(url.PROCESSADD+'/reply', data);
export const updateprocessaddApi = (data, id) => api.update(url.PROCESSADD+'/'+id, data);
export const getprocessadd = (data) => api.get(url.PROCESSADD+'/'+data);


export const getEmployessSelect = (data) => api.get(url.GET_EMPLOYEE+'/'+data);
export const getdashboardfunctionApi = (data) => api.get(url.GET_EMPLOYEE+'/'+data);
export const getCards = (data) => api.get(url.GET_CARD_REQUEST+data);
export const getCardsSelect = (data) => api.get(url.GET_CARD_REQUEST+'/'+data);
export const updateCardApi = (id, data) => api.update(url.CREATE_CARD_REQUEST+ '/'+id, data);
export const createCardApi = data => api.createmedia(url.CREATE_CARD_REQUEST, data);
export const createCardStatementApi = (data, id) => api.createmedia(url.CREATE_CARD+id, data);
export const updateCardStatementApi = (data, id) => api.update(url.CREATE_CARD+id, data);
export const createEmployeeCardApi = data => api.create(url.CREATE_CARD, data);
export const updateEmployeeCardApi = (data, id) => api.update(url.CREATE_CARD+'/'+id, data);
export const getEmployeeCards = (data) => api.get(url.CREATE_CARD);
export const getcashs = (data) => api.get(url.CREATE_CASH+data);
export const getcashsSelect = (data) => api.get(url.CREATE_CASH+'/'+data);
export const createcashApi = data => api.createmedia(url.CREATE_CASH, data);
export const createCashStatementApi = (data, id) => api.createmedia(url.CREATE_CASH+id, data);
export const updatecashApi = (data, id) => api.update(url.CREATE_CASH+'/'+id, data);
export const getdepartment = (data) => api.get(url.DEPARTMENT);
export const createdepartmentApi = data => api.createmedia(url.DEPARTMENT, data);
export const getdevision = (data) => api.get(url.DEVISION);
export const createdevisionApi = data => api.createmedia(url.DEVISION, data);
export const createroleApi = data => api.create(url.ROLE, data);
export const getposition = (data) => api.get(url.POSITION);
export const getrole = (data) => api.get(url.ROLE);

export const createpositionApi = data => api.createmedia(url.POSITION, data);

export const updateprojectionApi = (data, id) => api.update(url.PROJECTION + '/' + id, data);
export const createprojectionApi = data => api.create(url.PROJECTION, data);
export const getprojections = (data) => api.get(url.PROJECTION);

export const getEmployeeSupplierPOs = (data) => api.get(url.SUPPLIERPO);
export const createSupplierPOApi = data => api.create(url.SUPPLIERPO, data);
export const createExpenseApi = (data, endpoint) => api.createmedia(endpoint, data);
export const createSuppliersPaymentRequestApi = data => api.create(url.SUPPLIERPAYMENTREQUEST, data);
export const getSuppliersPaymentRequestApi = data => api.get(url.SUPPLIERPAYMENTREQUEST+data);
export const createSuppliersPaymentApi = data => api.create(url.SUPPLIERPAYMENT, data);
export const getSuppliersPaymentApi = data => api.get(url.SUPPLIERPAYMENT);
export const createSuppliersPaymentLineItemApi = data => api.create(url.SUPPLIERPAYMENTLINEITEM, data);
export const getSuppliersPaymentLineItemApi = data => api.get(url.SUPPLIERPAYMENTLINEITEM);
...
export const getFakeProfile = (data) => api.get(url.GET_PROFILE + '/' + data.phone);
